...
function ClimateMigrationAdmin() {
    ...
    const [locValue, setLocValue] = useState({name: '', longitude: '', latitude: ''})
    ...
    const locationUrl = 'http://localhost:5000/locations';
            ...
            <div>
                ...
                <form onSubmit={(e)=> handleSubmit(e)}>
                    <div>
                        ...
                        <input id="name" type="text" name="name" placeholder="location name" value={locValue.name} onChange={handleChange} />
                    </div>
                    <div>
                        <label htmlFor="longitude">Longitude : </label>
                        <input id="longitude" type="text" name="longitude" placeholder="longitude" value={locValue.longitude} onChange={handleChange} />
                    </div>
                    <div>
                        <label htmlFor="latitude">Latitude : </label>
                        <input id="latitude" type="text" name="latitude" placeholder="latitude" value={locValue.latitude} onChange={handleChange} />
                    </div>

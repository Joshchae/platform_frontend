        ...
        <div style={{ width: 700, backgroundColor: "beige", margin: '5rem' }}>
            <div>
              <Formik validationSchema={schema} 
                ...
                initialValues={{ region: 'Eastern Caribbean', country: '', locationName: '', title: '', story: '', image: null, email: '', nickname: '', }} >
                ...
                <Form noValidate onSubmit={handleSubmit} >
                    <Form.Group as={Col} md="10">
                        ...
                        <Form.Control as="select" id="region" name="region" value={values.region} onChange={handleChange} custom>
                            <option value='Eastern Caribbean'>Eastern Caribbean</option>
                            <option value='South Pacific'>South Pacific</option>
                            <option value='West Pacific'>West Pacific</option>
                            <option value='West Africa'>West Africa</option>
                    ...
                    <Form.Row>
                        ...
                        <Form.Label htmlFor="country">Name of Country</Form.Label>
                            <Form.Control id="country" type="text" name="country" placeholder="Write down your country"
                                value={values.country} onChange={handleChange} isValid={touched.country && !errors.country} isInvalid={!!errors.country} />
                            <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                        </Form.Group>
                        <Form.Group as={Col} md="5">
                            <Form.Label htmlFor="locationName">Name of City / Village</Form.Label>
                            <Form.Control id="locationName" type="text" name="locationName" placeholder="Write down your city or village"
                                value={values.locationName} onChange={handleChange} isValid={touched.locationName && !errors.locationName} isInvalid={!!errors.locationName} />
                            <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                        </Form.Group>
                    </Form.Row>
                    ...
                    <Form.Group as={Col} md="10">
                        ...
                        <Form.Control id="title" type="text" name="title" placeholder="Write donw title of your story"
                            value={values.title} onChange={handleChange} isValid={touched.title && !errors.title} isInvalid={!!errors.title} />
                        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                    </Form.Group>
                    ...
                    <Form.Group as={Col} md="10">
                        ...
                        <Form.Control
                            as="textarea" rows={3} 
                            id="story" type="text" name="story" placeholder="story"
                            value={values.story} onChange={handleChange} isValid={touched.story && !errors.story} isInvalid={!!errors.story} />
                        <Form.Control.Feedback>'Looks good!'</Form.Control.Feedback>
                    </Form.Group>

                    <Form.Group>
                        <Form.File className="position-relative" name="image" label="Image" onChange={handleChange} isInvalid={!!errors.file}
                            feedback={errors.file} feedbackTooltip />
                    </Form.Group>

                    <Form.Row>
                    <Form.Group as={Col} md="5">
                        <Form.Label htmlFor="email">Email Address</Form.Label>
                        <Form.Control id="email" type="email" name="email" placeholder="example@example.com"
                            value={values.email} onChange={handleChange} isValid={touched.email && !errors.email} isInvalid={!!errors.email} />
                        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                    </Form.Group>
                    <Form.Group as={Col} md="5">
                        <Form.Label htmlFor="nickname">Nickname</Form.Label>
                        <Form.Control id="nickname" type="text" name="nickname" placeholder="Write donw your nickname"
                            value={values.nickname} onChange={handleChange} isValid={touched.nickname && !errors.nickname} isInvalid={!!errors.nickname} />
                        <Form.Control.Feedback>Looks good!</Form.Control.Feedback>
                    </Form.Group>
                    </Form.Row>
